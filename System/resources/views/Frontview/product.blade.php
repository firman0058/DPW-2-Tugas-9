                ...
                <div class="card-body">
                    <form action="{{ url('product/filter')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <label for="" class="control-label"><b>CARI NAMA PRODUK</b></label>
                            <input type="text" class="form-control" name="nama" value="{{$nama ?? ""}}">
                            </div>
                            <button class="btn btn-dark float-right"><i class="fa fa-search"></i></button>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 margin_bottom1">
                            <div class="product_box">
                                <figure><img src="{{url('public')}}/images/l.png" width="200px" height="200px" alt="#"/></figure>
                                <a href=""><h3>{{$produk->nama}}</h3></a>
                        </div>
                    </div>
                        @endforeach
                        {{-- <div class="col-md-4 margin_bottom1">
